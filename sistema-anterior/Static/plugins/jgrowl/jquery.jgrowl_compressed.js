(function ($) {
    ...
    $.extend($.fn.jGrowl.prototype, {
        ...
        render: function (_1c) {
            ...
            var _1c = $("<div class=\"jGrowl-notification " + o.themeState + " ui-corner-all" + ((o.group != undefined && o.group != "") ? " " + o.group : "") + "\">" + "<div class=\"jGrowl-close\">" + o.closeTemplate + "</div>" +
                "<div class=\"jGrowl-header\">" + o.header + "</div>" + "<div class=\"jGrowl-message\">" + _1e + "</div></div>").data("jGrowl", o).addClass(o.theme).children("div.jGrowl-close").bind("click.jGrowl", function () {
