<ul id="mainnav-menu" class="list-group">
    ...
    <li><a href="javascript:;" onclick="fancybox('/filemanager/index/{{ USUARIO.personal.id }}?token={{ USUARIO.personal.getFileManagerToken() }}&p={{ base64_encode('R,C,U,D') }}&base=/')">{{ icon('world_go') }} Espacio Web</a></li>
    ...
    <li class="list-header">Alertas, Notificaciones</li>
    <li id="menu-alertas">
        <a href="#/alertas">
            {{ icon('email_error') }}
    ...
    <li id="menu-configuracion">
        ...
        <ul class="collapse">
            ...
            <li><a href="#/documentos_matriculas">Documentos Matrículas</a></li>
            <li><a href="#/sedes">Sedes</a></li>
            <li><a href="#/turnos">Turnos</a></li>

            <li><a href="#/configuracion/criterios">Criterios Globales</a></li>

            <li><a href="#/avatar_shop_items">Avatares</a></li>
        </ul>
    </li> 
