    ...
    $(function() {
        ...
        $('#formAsignar').bootstrapValidator({
            ...
            onSuccess: function(e) {
                ...
                $(_form).sendForm('/asignaturas_examenes/do_asignar', function(r) {
...
<form id="formAsignar" data-target="#formAsignar" data-toggle="overlay">
    <div class="modal-content modal-800">
        ...
        <div class="modal-body">
            <input type="hidden" name="examen_id" value="{{ asignatura_examen.id }}" />
            <input type="hidden" name="asignatura_id" value="{{ asignatura.id }}" />
            <input type="hidden" name="ciclo" value="{{ asignatura_examen.ciclo }}" />
