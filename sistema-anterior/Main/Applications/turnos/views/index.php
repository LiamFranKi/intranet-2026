			...
			<div class="pad-btm form-inline">
				<div class="row">
					<div class="col-sm-6 table-toolbar-left">
						<a href="#/turnos/form" class="btn btn-success btn-labeled fa fa-plus">Registrar Nuevo</a>
					</div>
				</div>
			</div>

			<table id="listaTurnos" class="table table-striped table-bordered">
				<thead>
					<tr>
						...
						<td class="text-center" style="width: 120px">
							<div class="btn-group dropup">
								...
								<ul class="dropdown-menu pull-right" role="menu">
									<li><a href="#/turnos/form/{{ sha1(turno.id) }}">{{ icon('register') }} Editar Turno</a></li>
									<li><a href="javascript:;" onclick="borrar_turno('{{ sha1(turno.id) }}')">{{ icon('delete') }} Borrar Turno</a></li>
								</ul>
							</div>
						</td>
					</tr>
