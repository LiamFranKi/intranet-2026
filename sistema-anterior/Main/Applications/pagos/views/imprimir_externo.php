...
<body>
    <div class="receipt">
        <div class="header">
            ...
            <div class="document-info">
                ...
                <div class="doc-number">
                    <span class="red-text">N°. {{ impresion.getSerieNumero() }}</span>
                </div>
            </div>
        </div>
        ...
        <div class="client-section">
            <div class="client-info">
                <div class="info-row">
                    ...
                    <div class="info-value">{{ pago.matricula.alumno.getFullName() }}</div>
                </div>
              
                <div class="info-row">
                    <div class="info-label">DNI:</div>
                    <div class="info-value">{{ pago.matricula.alumno.nro_documento }}</div>
                </div>
            </div>
            ...
            <div class="date-section">
                <table class="date-table">
                    ...
                    <tbody>
                        <tr>
                            <td>{{ pago.fecha_hora|date('d') }}</td>
                            <td>{{ pago.fecha_hora|date('m') }}</td>
                            <td>{{ pago.fecha_hora|date('Y') }}</td>
                        </tr>
                    </tbody>
                </table>
            </div>
        ...
        <table class="items-table">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>{{ pago.getDescription() }}</td>
                    <td class="text-center">{{ pago.monto|number_format(2) }}</td>
                </tr>
        ...
        <div class="total-section">
            ...
            <div class="total-value">{{ pago.getTotal()|number_format(2) }}</div>
        </div>
        
        <div class="account-info">
            <div class="account">{{ pago.forma_pago }}</div>
            <div class="status">
                <div class="status-title">ESTADO:</div>
                <div class="status-label">{{ pago.estado_pago }}</div>
            </div>
        </div>
