...
$(function(){
	...
	$('#formArea').bootstrapValidator({
		...
		onSuccess: function(e){
			...
			$(_form).sendForm('/areas/save', function(r){
	...
	<form class="form-horizontal" autocomplete="off" id="formArea" data-target="#formArea" data-toggle="overlay">
		<div class="panel">
			<div class="panel-heading">
				<h3 class="panel-title">{{ area.is_new_record() ? "Registrar" : "Editar" }} Area</h3>
			</div>
			<div class="panel-body">
				...
				<div class="form-group form-group-sm">
				    ...
				    <div class="col-sm-6 col-xs-12 col-lg-3">{{ form.nivel_id }}</div>
				</div>
