...
<script>
$(function(){
	$('#formAsignatura_Enlace').niftyOverlay();
	$('#formAsignatura_Enlace').bootstrapValidator({
		fields: {},
		onSuccess: function(e){
			...
			$(_form).sendForm('/asignaturas_enlaces/save', function(r){
...
<div id="page-head">
	<div id="page-title">
		<h1 class="page-header text-overflow">Enlaces de Ayuda</h1>
	</div>
	<ol class="breadcrumb">
		<li><a href="/"><i class="demo-pli-home"></i></a></li>
		<li class="active">Registro de Enlace</li>
	</ol>
</div>
<div id="page-content">

	<form class="form-horizontal" autocomplete="off" id="formAsignatura_Enlace" data-target="#formAsignatura_Enlace" data-toggle="overlay">
		<div class="panel">
			<div class="panel-heading">
				<h3 class="panel-title">{{ asignatura_enlace.is_new_record() ? "Registrar" : "Editar" }} Enlace</h3>
			</div>
